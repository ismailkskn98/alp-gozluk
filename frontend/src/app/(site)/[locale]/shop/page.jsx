...
export default async function ShopPage({ params, searchParams }) {
  ...
  return (
    <>
      ...
      <section className="grid-container py-12"><div><CatalogToolbar locale={locale} activeAudience={null} /><ProductGrid locale={locale} filters={{ type: query.type, sale: query.sale, sort: query.sort, material: query.material, feature: query.feature }} /></div></section>
    </>
  );
}
