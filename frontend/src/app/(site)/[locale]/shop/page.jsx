...
export default async function ShopPage({ params }) {
  ...
  return (
    <>
      ...
      <section className="grid-container py-12"><div><p className="mb-8 text-sm text-muted-foreground">{tr ? '6 ürün · Demo katalog' : '6 products · Demo catalogue'}</p><ProductGrid locale={locale} /></div></section>
    </>
  );
}
