...
const SquircleSegment = ({ asChild, cornerSmoothing = 1, leftRadius, rightRadius, className, style, children }) => {
...
const DurationField = ({ value, onValueChange, max, isEditing, shouldReduceMotion, disabled, swayX, inputRef }) => {
  ...
  return (
    <>
      ...
      />
      <span ref={measureRef} aria-hidden className="invisible absolute whitespace-pre font-semibold">
        {value || "0"}
      </span>
    </>
  );
  ...
  return (
    ...
    >
      ...
      <SquircleSegment
        ...
        style={{ marginLeft: segmentSpacing, paddingLeft: innerPadLeft, paddingRight: innerPadRight }}
