...
import { Children, Fragment, useCallback, isValidElement, useMemo, useRef, useState } from "react";
...
export function FileTreeFolder(_props) {
  return null;
}

export function FileTreeFile(_props) {
  return null;
}
...
function flattenItems(items, expanded, depth = 0, parentId = null) {
...
export function FileTree({
  ...
  const [focusedId, setFocusedId] = useState(value ?? defaultValue);
