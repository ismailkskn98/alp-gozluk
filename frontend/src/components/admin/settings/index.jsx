  ...
  return (
    <>
      ...
      <Tabs defaultValue="store" className="mt-5">
        ...
        <TabsContent value="shipping"><div className="space-y-5"><CommerceSettingsForm /><IntegrationSettings title="Kargo sağlayıcıları" icon={Truck} rows={['Aras Kargo', 'Yurtiçi Kargo', 'Mağazadan teslim']} /></div></TabsContent>
