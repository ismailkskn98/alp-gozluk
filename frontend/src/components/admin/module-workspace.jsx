    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <Tabs defaultValue="all"><TabsList><TabsTrigger value="all">Tümü</TabsTrigger><TabsTrigger value="active">Aktif</TabsTrigger><TabsTrigger value="draft">Taslak</TabsTrigger></TabsList></Tabs>
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Popover><PopoverTrigger asChild><AdminButton variant="secondary"><Filter className="size-4" />Filtre</AdminButton></PopoverTrigger><PopoverContent align="end"><div className="flex items-center justify-between"><p className="text-sm font-semibold">Filtreler</p><button type="button" className="text-xs text-primary">Temizle</button></div><div className="mt-4 space-y-3"><AdminFormField label="Durum"><select className={adminInputClass}><option>Tümü</option><option>Aktif</option><option>Taslak</option></select></AdminFormField><AdminButton className="w-full"><SlidersHorizontal className="size-4" />Uygula</AdminButton></div></PopoverContent></Popover>
